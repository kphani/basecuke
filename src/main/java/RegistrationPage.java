...
public class RegistrationPage {
    ...
    public WebElement postCode() {
        return driver.findElement(By.cssSelector("input[id='txtPostcode']"));
    }
    ...
    public WebElement pwd() {
        return driver.findElement(By.cssSelector("input[id='dnn_ctr29896_View_txtPassword']"));
    }
    ...
    public WebElement confirmButton() {
        return driver.findElement(By.xpath("//*[@id='dnn_ctr29896_View_cmdRegister']"));
    }

    public WebElement getValidationMess() {
        return driver.findElement(By.xpath("//*[@id='dnn_ctr29896_View_lblRegistrationErrorMessage']"));
    }
